# LoveKana Theme for Hugo

> As adorable as [Kana](https://www.twitch.tv/kana)

This theme is based on LoveIt theme (I've done a few modifications to LoveIt), and LoveIt theme is based on the original LeaveIt theme and KeepIt theme. 

Still WIP so it's quite a mess here.
